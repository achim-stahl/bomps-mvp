          ...
          <div className="max-w-4xl mx-auto space-y-16">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                Bomps is a next-generation, AI-ready ERP platform designed to help businesses of all sizes work smarter, faster, and more securely. Developed by <span className="font-semibold text-gray-900 dark:text-white">XSAVY GmbH</span> in Munich, Germany, Bomps combines powerful business management tools with modern, intuitive design — enabling you to focus on growth instead of juggling disconnected systems.
              </p>
            </div>

            {/* Mission */}
            <div className="bg-gradient-to-br from-brand-50 to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 md:p-12 border border-brand-100 dark:border-gray-700">
              <div className="flex items-start gap-4 mb-4">
                <div className="w-12 h-12 rounded-xl bg-brand-100 dark:bg-brand-900 flex items-center justify-center flex-shrink-0">
            ...
            {/* What We Offer */}
            <div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-8">What We Offer</h3>
              <div className="grid sm:grid-cols-2 gap-6">
                {offerings.map((item, index) => (
                  <div 
                    key={index}
                    className="p-6 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-brand-300 dark:hover:border-brand-600 hover:shadow-md transition-all"
                  >
            ...
            {/* Why Choose Bomps */}
            <div className="bg-gray-900 dark:bg-gray-950 text-white rounded-2xl p-8 md:p-12 border border-gray-800 dark:border-gray-900">
            ...
            <div className="text-center pt-8">
              <p className="text-gray-600 dark:text-gray-400">
                Developed by <span className="font-semibold text-gray-900 dark:text-white">XSAVY GmbH</span>
              </p>
              <p className="text-gray-600 dark:text-gray-400">Munich, Germany</p>
            </div>
          </div>
        </section>
      </main>
